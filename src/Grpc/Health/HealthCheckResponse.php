...
class HealthCheckResponse extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \iBllex\ServiceRegister\Grpc\Metadata\HealthCheck::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \iBllex\ServiceRegister\Grpc\Health\HealthCheckResponse\ServingStatus::class);
        $this->status = $var;
