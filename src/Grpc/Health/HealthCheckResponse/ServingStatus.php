...
namespace iBllex\ServiceRegister\Grpc\Health\HealthCheckResponse;
...
class_alias(ServingStatus::class, \iBllex\ServiceRegister\Grpc\Health\HealthCheckResponse_ServingStatus::class);
